...
export function TemplatesTab({ storeSettings, setStoreSettings }: TemplatesTabProps) {
  ...
  const FALLBACK_TEMPLATES: Template[] = [
    ...
    { id: 'pro-landing', name: 'Pro Landing', category: 'Single Product', icon: '🚀', description: 'Professional one-product landing page (story → proof → FAQ → buy).', image: '/template-previews/pro-landing.svg', colors: { primary: '#0b1220', secondary: '#0f172a', accent: '#2563eb' }, features: ['Split hero', 'Trust badges', 'FAQ section', 'Sticky buy bar'] },
