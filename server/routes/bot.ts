    ...
    if (existingResult.rows.length === 0) {
      ...
      await pool.query(
        `INSERT INTO bot_settings (
          ...
          telegram_bot_token, telegram_delay_minutes, viber_auth_token, viber_sender_name,
      ...
      await pool.query(
        `UPDATE bot_settings SET
          ...
          viber_auth_token = $10,
          viber_sender_name = $11,
          telegram_bot_username = $12,
          template_greeting = $13,
          template_instant_order = $14,
          template_pin_instructions = $15,
          template_order_confirmation = $16,
          template_payment = $17,
          template_shipping = $18,
          updated_at = NOW()
        WHERE client_id = $1`,
        [
          clientId,
